    ...
    function drawparticles() {
        ...
        for (j = 0; j < canvasData.length; j++) {
            ...
            for (i = 0; i < canvasData[j].numParticles; i++) {
                ...
                if (nowMilliseconds % modulus === 0) {
                    particle.style = sprites[Math.floor(Math.random() * 4)]
                }
